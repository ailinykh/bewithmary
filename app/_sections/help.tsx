      ...
      <div className={wrap}>
        ...
        <ul className="grid max-w-[70ch] list-none">
          {helpItems.map((t, i) => (
            <li
              key={i}
              className="grid grid-cols-[24px_1fr] items-baseline gap-3.5 border-t border-border py-4 text-[clamp(16px,1vw+0.3rem,18px)] leading-normal text-fg last:border-b last:border-border"
            >
        ...
        <p className="mt-7 max-w-[64ch] text-sm leading-[1.6] text-muted">
